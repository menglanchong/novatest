...
public class ClearDangerSourceTest {
    ...
    * */
    ...
    public static void clearProject(){
        ...
        //调用清空方法
        ClearService.clearTextService(DangerSourcePage.JNAME, DangerSourcePage.PROJECTEMPTY,"可以");
    ...
    public static void clearTest1(){
        ...
        //调用清空方法
        ClearService.clearTextService(DangerSourcePage.PROJECTLEADER, DangerSourcePage.INQUERYBOX,"小张");
    }
    @Test
