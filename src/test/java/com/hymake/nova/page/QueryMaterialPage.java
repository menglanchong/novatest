...
public class QueryMaterialPage {
    ...
    public static By SGUNIT=By.name("seek_sgUnit_like");//承包单位
    ...
    public static By RECOREPRONAME=By.name("seek_proName");
    public static By REPORTTYPE=By.name("seek_reportFormType");
    public static By JSUNIT=By.name("seek_jsUnitName");
    public static By SGUNITNAME=By.name("seek_sgUnitName");
    public static By JLUNIT=By.name("seek_jlUnitName");
    public static By SUBMITSTART=By.xpath(".//*[@id='materialCheckQuery']/div[1]/ul/li[6]/center/div/div[1]/input");
    public static By SUBMITEND=By.xpath(".//*[@id='materialCheckQuery']/div[1]/ul/li[6]/center/div/div[2]/input");
    public static By REPORTSTART=By.xpath(".//*[@id='materialCheckQuery']/div[1]/ul/li[7]/center/div/div[1]/input");
    public static By REPORTEND=By.xpath(".//*[@id='materialCheckQuery']/div[1]/ul/li[7]/center/div/div[2]/input");
    public static By SEARCHRECORD=By.xpath(".//*[@id='materialCheckQuery']/div[1]/div/button[1]");
