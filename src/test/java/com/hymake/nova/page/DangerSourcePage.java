...
public class DangerSourcePage {
    ...
    public static By JNAME =By.xpath(".//*[@id='ds_regist-list-tab']/div[1]/ul/li/center/div/input");//工程项目查询
   ...
   // public static By cxlb=By.xpath(".//*[@id='app']/div/div/div[2]/div/div[2]/form/div/button[1]");//查询列表
    ...
    public static By INDANGERTYPE =By.xpath("./[@id='ds_regist-wait-tab']/div[1]/ul/li[3]/center/div/select");//在办选择危险性类型
